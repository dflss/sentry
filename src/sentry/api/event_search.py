...
from sentry.search.events.constants import KEY_TRANSACTION_ALIAS, SEARCH_MAP, TAG_KEY_RE, TEAM_KEY_TRANSACTION_ALIAS
...
class SearchVisitor(NodeVisitor):
    ...
    boolean_keys = {"error.handled", "error.unhandled", "stack.in_app", KEY_TRANSACTION_ALIAS, TEAM_KEY_TRANSACTION_ALIAS}
